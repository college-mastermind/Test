...
const CaseStudy = () => {
  ...
  return (
    <div className="flex justify-center items-center my-20">
      <div className="bg-[#FDF9FF] flex flex-col items-center justify-center w-full max-w-[1241px] min-h-fit pt-10 pb-1 sm:pt-12 sm:pb-2 md:pt-12 md:pb-2 lg:pt-16 lg:pb-3 px-1 sm:px-2 md:px-2 lg:px-3 rounded-xl sm:rounded-2xl shadow-xl">
        ...
        <div className="flex flex-col w-full">
          <div className="bg-gradient-to-b from-[#01B7FD] to-[#007FB0] p-2 sm:p-3 md:p-4 lg:p-5 rounded-xl sm:rounded-2xl">
            <span className="inline-block bg-white text-[#01B7FD] px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-1 rounded-xl text-xs sm:text-sm md:text-base font-semibold mb-2 sm:mb-3 md:mb-4 shadow-md">
              Case Study
            </span>
              ...
              {isExpanded ? (
                <div className="flex flex-col items-center mt-2 sm:mt-3 md:mt-4">
                  <button
                    ...
                    className="text-white text-sm sm:text-base md:text-lg font-semibold flex flex-col items-center gap-1 sm:gap-1.5 md:gap-2 hover:text-zinc-200 transition-colors duration-200"
                  >
                    View Less
                    <svg
                ...
                <button
                  ...
                  className="absolute bottom-1 sm:bottom-2 md:bottom-3 lg:bottom-4 left-1/2 transform -translate-x-1/2 text-white z-10 text-sm sm:text-base md:text-lg font-semibold flex flex-col items-center gap-1 sm:gap-1.5 md:gap-2 hover:text-zinc-200 transition-colors duration-200"
                >
